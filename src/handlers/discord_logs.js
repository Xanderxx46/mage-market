...
// Configuration - Update with your mod log channel ID
const MOD_LOG_CHANNEL_ID = '1461117865112637490';
...
/**
 * Initialize mod logging system
 * @param {Client} client - The Discord client instance
 */
export function initializeModLogs(client) {
...
export function setupFullLogger(client) {
  ...
  client.on('guildMemberRemove', async member => {
    setTimeout(async () => {
      ...
      // Remove user from events database (if database module exists)
      try {
        const { removeUserFromEventsDatabase } = await import('../../core/database/database.js');
        ...
        // Database module doesn't exist or error occurred - silently continue
        // Uncomment the line below if you want to see database errors
